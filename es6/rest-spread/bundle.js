...
function soma() {
  ...
  return params.reduce(function (accumulator, item) {
    return accumulator + item;
  });
}

console.log(soma(2, 3, 4, 5, 6)); // SPREAD (enquanto o REST pega o resto de uma desestruturação ou de uma passagem de parâmetros,
